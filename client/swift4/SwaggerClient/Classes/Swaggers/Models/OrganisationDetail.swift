...
public struct OrganisationDetail: Codable {
    ...
    public init(lastUpdateTime: String, agentFirstName: String?, agentLastName: String, agentRole: String, businessName: String, legalName: String?, shortName: String?, abn: String?, acn: String?, isACNCRegistered: Bool?, industryCode: String?, organisationType: OrganisationType, registeredCountry: String?, establishmentDate: String?, physicalAddresses: [PhysicalAddressWithPurpose]) { 
