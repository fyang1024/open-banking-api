...
public struct ProductFees: Codable {
    ...
    public var discounts: [ProductDiscounts]?
    public init(name: String, feeType: FeeType, amount: String?, balanceRate: String?, transactionRate: String?, currency: String?, additionalValue: String?, additionalInfo: String?, additionalInfoUri: String?, discounts: [ProductDiscounts]?) { 
        self.name = name
