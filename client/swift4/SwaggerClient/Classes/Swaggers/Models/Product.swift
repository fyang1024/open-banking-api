...
public struct Product: Codable {
    ...
    public init(productId: String, effectiveFrom: String?, effectiveTo: String?, lastUpdated: String, productCategory: EnumProductCategory, name: String, _description: String, brand: String, brandName: String?, applicationUri: String?, isTailored: Bool, additionalInformation: ProductAdditionalInformation?) { 
