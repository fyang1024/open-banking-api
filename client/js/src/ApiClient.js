...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ConsumerDataStandards.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://data.provider.com.au/cds-au/v1
     */
    this.basePath = 'https://data.provider.com.au/cds-au/v1'.replace(/\/+$/, '');
