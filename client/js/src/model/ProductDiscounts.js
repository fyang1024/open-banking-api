...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ConsumerDataStandards.ProductDiscounts = factory(root.ConsumerDataStandards.ApiClient);
  }
  ...
  /**
   * The ProductDiscounts model module.
   * @module model/ProductDiscounts
   * @version 1-oas3
   */

  /**
   * Constructs a new <code>ProductDiscounts</code>.
   * @alias module:model/ProductDiscounts
   * @class
   * @param description {String} Description of the discount
   * @param discountType {module:model/ProductDiscounts.DiscountTypeEnum} The type of discount. See the next section for an overview of valid values and their meaning
  ...
  /**
   * Constructs a <code>ProductDiscounts</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProductDiscounts} obj Optional instance to populate.
   * @return {module:model/ProductDiscounts} The populated <code>ProductDiscounts</code> instance.
   */
   ...
   * @member {module:model/ProductDiscounts.DiscountTypeEnum} discountType
   */
