...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumerDataStandards.DomesticPayeeAccount();
  });
  ...
  describe('DomesticPayeeAccount', function() {
    it('should create an instance of DomesticPayeeAccount', function() {
      // uncomment below and update the code to test DomesticPayeeAccount
      //var instance = new ConsumerDataStandards.DomesticPayeeAccount();
      //expect(instance).to.be.a(ConsumerDataStandards.DomesticPayeeAccount);
    });
