...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumerDataStandards.ProductLendingRates();
  });
  ...
  describe('ProductLendingRates', function() {
    it('should create an instance of ProductLendingRates', function() {
      // uncomment below and update the code to test ProductLendingRates
      //var instance = new ConsumerDataStandards.ProductLendingRates();
      //expect(instance).to.be.a(ConsumerDataStandards.ProductLendingRates);
    });
