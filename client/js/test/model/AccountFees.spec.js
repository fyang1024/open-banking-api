...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumerDataStandards.AccountFees();
  });
  ...
  describe('AccountFees', function() {
    it('should create an instance of AccountFees', function() {
      // uncomment below and update the code to test AccountFees
      //var instance = new ConsumerDataStandards.AccountFees();
      //expect(instance).to.be.a(ConsumerDataStandards.AccountFees);
    });
