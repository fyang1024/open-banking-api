...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumerDataStandards.LendingBalance();
  });
  ...
  describe('LendingBalance', function() {
    it('should create an instance of LendingBalance', function() {
      // uncomment below and update the code to test LendingBalance
      //var instance = new ConsumerDataStandards.LendingBalance();
      //expect(instance).to.be.a(ConsumerDataStandards.LendingBalance);
    });
    ...
    it('should have the property amortisedLimit (base name: "amortisedLimit")', function() {
      // uncomment below and update the code to test the property amortisedLimit
      //var instance = new ConsumerDataStandards.LendingBalance();
      //expect(instance).to.be();
    });
