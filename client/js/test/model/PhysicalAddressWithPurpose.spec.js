...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumerDataStandards.PhysicalAddressWithPurpose();
  });
  ...
  describe('PhysicalAddressWithPurpose', function() {
    it('should create an instance of PhysicalAddressWithPurpose', function() {
      // uncomment below and update the code to test PhysicalAddressWithPurpose
      //var instance = new ConsumerDataStandards.PhysicalAddressWithPurpose();
      //expect(instance).to.be.a(ConsumerDataStandards.PhysicalAddressWithPurpose);
    });
