...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumerDataStandards.LinksPaginated();
  });
  ...
  describe('LinksPaginated', function() {
    it('should create an instance of LinksPaginated', function() {
      // uncomment below and update the code to test LinksPaginated
      //var instance = new ConsumerDataStandards.LinksPaginated();
      //expect(instance).to.be.a(ConsumerDataStandards.LinksPaginated);
    });
