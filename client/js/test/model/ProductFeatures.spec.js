...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumerDataStandards.ProductFeatures();
  });
  ...
  describe('ProductFeatures', function() {
    it('should create an instance of ProductFeatures', function() {
      // uncomment below and update the code to test ProductFeatures
      //var instance = new ConsumerDataStandards.ProductFeatures();
      //expect(instance).to.be.a(ConsumerDataStandards.ProductFeatures);
    });
