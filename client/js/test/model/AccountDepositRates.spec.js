...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumerDataStandards.AccountDepositRates();
  });
  ...
  describe('AccountDepositRates', function() {
    it('should create an instance of AccountDepositRates', function() {
      // uncomment below and update the code to test AccountDepositRates
      //var instance = new ConsumerDataStandards.AccountDepositRates();
      //expect(instance).to.be.a(ConsumerDataStandards.AccountDepositRates);
    });
