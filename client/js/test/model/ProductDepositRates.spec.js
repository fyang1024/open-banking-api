...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumerDataStandards.ProductDepositRates();
  });
  ...
  describe('ProductDepositRates', function() {
    it('should create an instance of ProductDepositRates', function() {
      // uncomment below and update the code to test ProductDepositRates
      //var instance = new ConsumerDataStandards.ProductDepositRates();
      //expect(instance).to.be.a(ConsumerDataStandards.ProductDepositRates);
    });

    it('should have the property depositRateType (base name: "depositRateType")', function() {
      // uncomment below and update the code to test the property depositRateType
      //var instance = new ConsumerDataStandards.ProductDepositRates();
