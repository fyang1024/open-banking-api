...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumerDataStandards.AccountDiscounts();
  });
  ...
  describe('AccountDiscounts', function() {
    it('should create an instance of AccountDiscounts', function() {
      // uncomment below and update the code to test AccountDiscounts
      //var instance = new ConsumerDataStandards.AccountDiscounts();
      //expect(instance).to.be.a(ConsumerDataStandards.AccountDiscounts);
    });
