...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumerDataStandards.MetaPaginated();
  });
  ...
  describe('MetaPaginated', function() {
    it('should create an instance of MetaPaginated', function() {
      // uncomment below and update the code to test MetaPaginated
      //var instance = new ConsumerDataStandards.MetaPaginated();
      //expect(instance).to.be.a(ConsumerDataStandards.MetaPaginated);
    });
