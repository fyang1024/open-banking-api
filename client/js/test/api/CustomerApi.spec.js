...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumerDataStandards.CustomerApi();
  });
  ...
  describe('CustomerApi', function() {
    ...
    describe('getCustomerDetail', function() {
      it('should call getCustomerDetail successfully', function(done) {
        //uncomment below and update the code to test getCustomerDetail
        //instance.getCustomerDetail(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
