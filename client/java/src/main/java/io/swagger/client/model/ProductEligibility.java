...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-14T03:38:22.905Z[GMT]")public class ProductEligibility {
  /**
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(eligibilityType, additionalValue, additionalInfo, additionalInfoUri);
  }
