...
import io.swagger.client.model.DirectDebits;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-14T03:38:22.905Z[GMT]")public class ResponseBankingDirectDebitsData {

  @SerializedName("directDebitAuthorisations")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(directDebitAuthorisations);
  }
