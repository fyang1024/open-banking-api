...
import io.swagger.client.model.DomesticPayeeAccount;
import io.swagger.client.model.DomesticPayeeCard;
import io.swagger.client.model.DomesticPayeePayId;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-14T03:38:22.905Z[GMT]")public class DomesticPayee {
  /**
  ...
  @SerializedName("payeeAccountUType")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(payeeAccountUType, account, card, payId);
  }
