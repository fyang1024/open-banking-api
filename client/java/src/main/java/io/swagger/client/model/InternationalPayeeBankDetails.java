...
import io.swagger.client.model.InternationalPayeeBankDetailsBankAddress;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-14T03:38:22.905Z[GMT]")public class InternationalPayeeBankDetails {
  ...
  @SerializedName("beneficiaryBankBIC")
  ...
  @SerializedName("legalEntityIdentifier")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(country, accountNumber, bankAddress, beneficiaryBankBIC, fedWireNumber, sortCode, chipNumber, routingNumber, legalEntityIdentifier);
  }
