...
import org.openapitools.server.models.ProductDiscounts
...
data class ProductFees (
    ...
    /* The type of fee */
    val feeType: ProductFees.FeeType,
    ...
    val discounts: kotlin.Array<ProductDiscounts>? = null
) {

    /**
    * The type of fee
    * Values: pERIODIC,tRANSACTION,eSTABLISHMENT,eXIT,oVERDRAW,mINBALANCE,rEDRAW,cHEQUECASH,cHEQUESTOP,cHEQUEBOOK,cARDREPLACE,pAPERSTATEMENT,oTHEREVENT
    */
