...
public interface BankingApi {
    ...
    @ApiOperation(
            ...
            response = ResponseBankingAccount.class,
            authorizations = {@Authorization(
                        value = "OAuth2",
                        scopes = {@AuthorizationScope(scope = "accounts", description = "Read accounts information")})},
            tags = {"Accounts",})
    @ApiResponses(value = {
    ...
    default ResponseEntity<ResponseBankingAccount> getAccountDetail(
            @ApiParam(value = "A tokenised identifier for the account which is unique but not shareable", required = true)
    ...
    @ApiOperation(
            ...
            response = ResponseBankingPayeeDetails.class,
            authorizations = {@Authorization(
                    value = "OAuth2",
                    scopes = {@AuthorizationScope(scope = "payees", description = "Read payees information")})},
            tags = {"Payees",})
    @ApiResponses(value = {
    ...
    @RequestMapping(
            ...
            produces = {"application/json"},
            method = RequestMethod.GET)
    default ResponseEntity<ResponseBankingPayeeDetails> getPayeeDetail(
            @ApiParam(value = "The ID used to locate the details of a particular payee", required = true)
    ...
    @ApiOperation(
            ...
            response = ResponseBankingProduct.class,
            authorizations = {@Authorization(
                    value = "OAuth2",
                    scopes = {@AuthorizationScope(scope = "products", description = "Read products information")})},
            tags = {"Products",})
    @ApiResponses(value = {
    ...
    @RequestMapping(
            ...
            produces = {"application/json"},
            method = RequestMethod.GET)
    default ResponseEntity<ResponseBankingProduct> getProductDetail(
    ...
    @ApiOperation(
            ...
            response = ResponseBankingTransactionDetail.class,
            authorizations = {@Authorization(
                    value = "OAuth2",
                    scopes = {@AuthorizationScope(scope = "accounts", description = "Read accounts information")})},
            tags = {"Accounts",})
    ...
    @RequestMapping(
            ...
            produces = {"application/json"},
            method = RequestMethod.GET)
    default ResponseEntity<ResponseBankingTransactionDetail> getTransactionDetail(
            @ApiParam(value = "The account id token that is used to uniquely represent the account", required = true)
            @PathVariable("accountId") String accountId,
            @ApiParam(value = "The unique identifier for the specific transaction for which details are being requested", required = true)
    ...
    @ApiOperation(
            ...
            response = ResponseBankingTransactions.class,
            authorizations = {@Authorization(
                    value = "OAuth2",
                    scopes = {@AuthorizationScope(scope = "accounts", description = "Read accounts information")})},
            tags = {"Accounts",})
    ...
    @RequestMapping(
            ...
            produces = {"application/json"},
            method = RequestMethod.GET)
    default ResponseEntity<ResponseBankingTransactions> getTransactions(
            @ApiParam(value = "ID of the account to get transactions for.  Must have previously been returned by one of the account list end points.", required = true)
            @PathVariable("accountId") String accountId,
            @ApiParam(value = "Constrain the transaction history request to transactions with effective time at or after this date/time. If absent defaults to current time. Format is aligned to DateTimeString common type")
            @Valid @RequestParam(value = "start-time", required = false) String startTime,
            @ApiParam(value = "Constrain the transaction history request to transactions with effective time at or before this date/time. If absent defaults to start-time plus 100 days. Format is aligned to DateTimeString common type")
            @Valid
            @RequestParam(value = "end-time", required = false) String endTime,
            @ApiParam(value = "Filter transactions to only transactions with amounts higher or equal to than this amount")
            @Valid @RequestParam(value = "min-amount", required = false) String minAmount,
            @ApiParam(value = "Filter transactions to only transactions with amounts less than or equal to than this amount")
            @Valid
            @RequestParam(value = "max-amount", required = false) String maxAmount,
            @ApiParam(value = "Filter transactions to only transactions where this string value is found as a substring of either the reference or description fields. Format is arbitrary ASCII string")
            @Valid
    ...
    @ApiOperation(
            ...
            response = ResponseBankingAccounts.class,
            authorizations = {@Authorization(
                    value = "OAuth2",
                    scopes = {@AuthorizationScope(scope = "accounts", description = "Read accounts information")})},
            tags = {"Accounts",})
    ...
    @ApiOperation(
            ...
            response = ResponseBankingAccountsBalances.class,
            authorizations = {@Authorization(
                    value = "OAuth2",
                    scopes = {@AuthorizationScope(scope = "accounts", description = "Read accounts information")})},
            tags = {"Accounts",})
    ...
    @RequestMapping(
            ...
            produces = {"application/json"},
            method = RequestMethod.GET)
    default ResponseEntity<ResponseBankingAccountsBalances> listBalancesBulk(
            @ApiParam(value = "Used to filter results according to open/closed status. Values can be OPEN, CLOSED or ALL. If absent then ALL is assumed", allowableValues = "OPEN, CLOSED, ALL", defaultValue = "ALL")
            @Valid
            @RequestParam(value = "open-status", required = false, defaultValue = "ALL") String openStatus,
            @ApiParam(value = "Filters accounts based on whether they are owned by the authorised customer", allowableValues = "OWNED, NOT_OWNED, ALL", defaultValue = "ALL")
            @Valid
            @RequestParam(value = "is-owned", required = false, defaultValue = "ALL") String isOwned,
    ...
    @ApiOperation(
            ...
            response = ResponseBankingDirectDebits.class,
            authorizations = {@Authorization(
                    value = "OAuth2",
                    scopes = {@AuthorizationScope(scope = "direct-debits", description = "Read direct debits information")})},
            tags = {"Direct Debits",})
    @ApiResponses(value = {
    ...
    @RequestMapping(
            ...
            produces = {"application/json"},
            method = RequestMethod.GET)
    default ResponseEntity<ResponseBankingDirectDebits> listDirectDebits(
            @ApiParam(value = "ID of the account to get direct debit authorisations for.  Must have previously been returned by one of the account list end points.", required = true)
            @PathVariable("accountId") String accountId,
            @ApiParam(value = "Page of results to request (standard pagination)", defaultValue = "1")
            @Valid
            @RequestParam(value = "page", required = false, defaultValue = "1") Integer page,
    ...
    @RequestMapping(
            ...
            produces = {"application/json"},
            method = RequestMethod.GET)
    default ResponseEntity<ResponseBankingDirectDebits> listDirectDebitsBulk(
            @ApiParam(value = "Filters accounts based on whether they are owned by the authorised customer", allowableValues = "OWNED, NOT_OWNED, ALL", defaultValue = "ALL")
            @Valid
            @RequestParam(value = "is-owned", required = false, defaultValue = "ALL") String isOwned,
            @ApiParam(value = "Used to filter results on the productCategory field applicable to accounts. Any one of the valid values for this field can be supplied. If absent then all accounts returned.", allowableValues = "PERS_AT_CALL_DEPOSITS, BUS_AT_CALL_DEPOSITS, TERM_DEPOSITS, RESIDENTIAL_MORTGAGES, PERS_CRED_AND_CHRG_CARDS, BUS_CRED_AND_CHRG_CARDS, PERS_LOANS, PERS_LEASING, BUS_LEASING, TRADE_FINANCE, PERS_OVERDRAFT, BUS_OVERDRAFT, BUS_LOANS, FOREIGN_CURR_AT_CALL_DEPOSITS, FOREIGN_CURR_TERM_DEPOSITS, FOREIGN_CURR_LOAN, FOREIGN_CURRRENCT_OVERDRAFT, TRAVEL_CARD")
    ...
    @RequestMapping(
            ...
            consumes = {"application/json"},
            method = RequestMethod.POST)
    default ResponseEntity<ResponseBankingDirectDebits> listDirectDebitsSpecificAccounts(
            @ApiParam(value = "The list of account IDs to obtain information for", required = true)
            @Valid
            @RequestBody RequestAccountIds requestAccountIds) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType : MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"data\" : {    \"directDebitAuthorisations\" : [ {      \"lastDebitAmount\" : \"lastDebitAmount\",      \"accountId\" : \"accountId\",      \"lastDebitDateTime\" : \"lastDebitDateTime\",      \"authorisedEntity\" : {        \"arbn\" : \"arbn\",        \"name\" : \"name\",        \"financialInstitution\" : \"financialInstitution\",        \"abn\" : \"abn\",        \"acn\" : \"acn\"      }    }, {      \"lastDebitAmount\" : \"lastDebitAmount\",      \"accountId\" : \"accountId\",      \"lastDebitDateTime\" : \"lastDebitDateTime\",      \"authorisedEntity\" : {        \"arbn\" : \"arbn\",        \"name\" : \"name\",        \"financialInstitution\" : \"financialInstitution\",        \"abn\" : \"abn\",        \"acn\" : \"acn\"      }    } ]  },  \"meta\" : {    \"totalRecords\" : 0,    \"totalPages\" : 6  },  \"links\" : {    \"next\" : \"next\",    \"last\" : \"last\",    \"prev\" : \"prev\",    \"self\" : \"self\",    \"first\" : \"first\"  }}");
    ...
    @ApiOperation(
            ...
            response = ResponseBankingPayees.class,
            authorizations = {@Authorization(
                    value = "OAuth2",
                    scopes = {@AuthorizationScope(scope = "payees", description = "Read payees information")})},
            tags = {"Payees",})
    ...
    @RequestMapping(
            ...
            produces = {"application/json"},
            method = RequestMethod.GET)
    default ResponseEntity<ResponseBankingPayees> listPayees(
            @ApiParam(value = "Filter on the payee type field.  In addition to normal type field values, ALL can be specified to retrieve all payees.  If absent the assumed value is ALL", allowableValues = "DOMESTIC, INTERNATIONAL, BILLER", defaultValue = "ALL")
            @Valid
    ...
    @ApiOperation(
            ...
            response = ResponseBankingProducts.class,
            authorizations = {@Authorization(
                    value = "OAuth2",
                    scopes = {@AuthorizationScope(scope = "products", description = "Read products information")})},
            tags = {"Products",})
    ...
    @RequestMapping(
            ...
            produces = {"application/json"},
            method = RequestMethod.GET)
    default ResponseEntity<ResponseBankingProducts> listProducts(
            @ApiParam(value = "Allows for the filtering of products based on whether the current time is within the period of time defined as effective by the effectiveFrom and effectiveTo fields.  If absent defaults to 'CURRENT'", allowableValues = "CURRENT, FUTURE, ALL", defaultValue = "CURRENT")
            @Valid
            ...
            @Valid
            @RequestParam(value = "updated-since", required = false) String updatedSince,
    ...
    @ApiOperation(
            value = "Get Transactions For Multiple Accounts",
            nickname = "listTransactionsBulk",
            notes = "Obtain transactions for multiple, filtered accounts",
            response = ResponseBankingTransactions.class,
            authorizations = {@Authorization(
                    value = "OAuth2",
                    scopes = {@AuthorizationScope(scope = "accounts", description = "Read accounts information")})},
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Success", response = ResponseBankingTransactions.class)})
    @RequestMapping(
            value = "/banking/accounts/transactions",
            produces = {"application/json"},
            method = RequestMethod.GET)
    ...
    @ApiOperation(
            value = "Get Transactions For Specific Accounts",
            nickname = "listTransactionsSpecificAccounts",
            notes = "Obtain transactions for a specified list of transactions.",
            response = ResponseBankingTransactions.class,
            authorizations = {@Authorization(
                    value = "OAuth2",
                    scopes = {@AuthorizationScope(scope = "accounts", description = "Read accounts information")})},
